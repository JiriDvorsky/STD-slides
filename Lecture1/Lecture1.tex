...
\begin{frame}[fragile]
	\frametitle{Distribuce \hologo{TeX}u/\hologo{LaTeX}u}
	Podobně jako OS Linux je \hologo{LaTeX} a spolupracující software dostupný ve formě tzv.\ \emph{distribucí}:
	\begin{description}
...
\begin{frame}[fragile]
	\frametitle{\hologo{LaTeX} online}
	\begin{center}
...
\begin{frame}
	...
	\centering
	\resizebox{\textwidth}{!}{\input{Lecture1/Figures/OutputFormatsAndCompilers.tikz}}
\end{frame}
...
\begin{frame}
	...
	\centering
	\input{Lecture1/Figures/CompilationProcess.tikz}
\end{frame}
...
\end{document}
	...
	\par
	 ...
	 Překlad probíhá pomnocí \hologo{pdfLaTeX}u.
\end{frame}
